...
class Moka
{
    ...
    {
        return \idfly\moka\Spy::factory($result);
    }
    ...
    {
        $name = '__idfly_moka_' . static::$_counter . '';
        static::$_counter += 1;
...
CONSTRUCTOR;
    ...
    public function __construct()
    {
        ...
        \$this->__moka = \idfly\moka\Stubs::factory();
        \idfly\Moka::__setMokaValues(\$this->__moka, self::\$__mokaValues);
        $construct
    }
