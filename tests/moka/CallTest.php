...
class CallTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('idfly\moka\Call', $this->_call->returns(null));
    }
    ...
    {
        $this->assertInstanceOf('idfly\moka\Call', $this->_call->with('VALUE'));
    }
    ...
    {
        $this->assertInstanceOf('idfly\moka\Call', $this->_call->at(0));
    }
